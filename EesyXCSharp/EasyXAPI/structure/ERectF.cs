...
using CT = System.Single;
using POINT = Cheng.EasyX.DataStructure.EPointS;
using RECT = Cheng.EasyX.DataStructure.ERectF;
...
namespace Cheng.EasyX.DataStructure
{
    ...
    /// 一个单精度浮点矩形
    /// </summary>
    public struct ERectF : IEquatable<ERectF>
    {
        ...
        public ERectF(CT x, CT y, CT width, CT height)
        {
            this.x = x;
            this.y = y;
            this.width = width;
        ...
        /// <param name="width">x坐标方向长度</param>
        /// <param name="height">y坐标方向长度</param>
        public ERectF(POINT leftUp, CT width, CT height)
        {
            this.x = leftUp.x;
            this.y = leftUp.y;
            this.width = width;
        ...
        public ERectF(POINT leftUp, POINT rightDown)
        {
            this.x = leftUp.x;
            this.y = leftUp.y;
        ...
        /// <summary>
        /// 强制转化为<see cref="ERect"/>
        /// </summary>
        /// <param name="rect"></param>
        public static explicit operator ERect(RECT rect)
        {
            return new ERect((int)rect.Left, (int)rect.Top, (int)rect.Right, (int)rect.Bottom);
        }
        ...
        /// </summary>
        /// <param name="rect"></param>
        public static explicit operator RECT(ERect rect)
        {
